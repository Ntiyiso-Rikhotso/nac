...
<title>NAC | Careers at NAC </title>
  ...
  <div class="site-wrapper">
    ...
    <section class="section-side-image clearfix">
      <div class="img-holder col-md-12 col-sm-12 col-xs-12">
        <div class="background-imgholder" style="background:url(uploads/images/page/headers/header1.jpg);"><img class="nodisplay-image" src="images/header-inner-1.jpg" alt=""/> </div>
      </div>
            ...
            <div class="header-inner less-height">
              <div class="overlay">
                <div class="text text-center">
                  <h3 class="uppercase text-white less-mar-1 title">Careers at NAC</h3>
                  <h6 class="uppercase text-white sub-title">Career opportunities at NAC</h6>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <ol class="breadcrumb">
                ...
                <li class="current"><a href="#">Careers at NAC</a></li>
              </ol>
            </div>
          </div>
        </div>

<h2>
   <center class="page-title"><?php echo $secondary_title; ?></center>
</h2>
...
<div id="search-result">
   ...
   <?php foreach($categories as $category){ 
      $this->db->where('category.category_name', 'helicopter');
      ...
      <div class="container">
         ...
         <div class="row">
            ...
            <?php 
               ...
               ?>
            <div class="col-md-4 col-sm-6 col-xs-12"> 
               <a class="btn btn-prim btn-round btn-block btn-medium uppercase mybuttonfull" href="<?php echo base_url('helicopter/details/'. $name . '/' .$flight->flight_id); ?>"> VIEW AIRCRAFT SPECS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i></a>
            </div>
            <!--end col main-->
            <div class="col-md-4 col-sm-6 col-xs-12"> 

   ...
   <div class="container-fluid">
      <div class="clearfix"></div>
       ...
       <?php 
                ...
                $this->db->or_where('description', 'midsize_jets');
                $this->db->or_where('description', 'twin_turbine_aircraft');
                $this->db->or_where('description', 'twin_piston_aircraft');
                $this->db->or_where('description', 'large_passenger_transport');
                $this->db->or_where('description', 'regional_airliner');
                $this->db->or_where('description', 'super_midsize_jets');
    ...
    <br>
      <div class="container">
         <div class="mybanner">
            <p><?php echo ucwords(str_replace('_', ' ', $sub->description)); ?></p>
         </div>
         <br>
      </div>
      <div class="container">

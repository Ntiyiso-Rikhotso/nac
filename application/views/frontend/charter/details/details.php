...
<section class="sec-padding section-white">
   <div class="container">
   <h2><center><?php echo $secondary_title; ?></center></h2>
   <br>
      <div class="mybanner">
                  ...
                  <?php }else{ ?>
                     ...
                     <tbody>
                       ...
                       <!-- <tr>
                        ...
                        <?php if($flight->service_description == 'charter'){ ?>
                        <tr>
                           <td><b>Crew</b></td>
                           <td align="right"><?php echo $flight->crew; ?></td>
                        </tr>
                        <tr>
                           <td><b>Estimated cruise speed</b></td>
                           <td align="right"><?php echo $flight->estimated_cruise_speed; ?></td>
                        </tr>
                        <tr>
                           <td><b>Typical Use</b></td>
                           <td align="right"><?php echo $flight->typical_use; ?></td>
                        </tr>
                        <tr>
                           <td><b>Estimated range</b></td>
                           <td align="right"><?php echo $flight->estimated_range; ?></td>
                        </tr>
                        <tr>
                           <td><b>Range from</b></td>
                           <td align="right"><?php echo $flight->range_from; ?></td>
                        </tr>
                        <?php } ?>
                     </tbody>
                  </table>
      ...
      <div class="container">
        <div class="row">
          <div id="owl-demo11" class="owl-carousel owl-theme">
            <?php 
             $this->db->limit(5);
             $this->db->where('flight.flight_id <>', $flight->flight_id);
             $this->db->where('sub_category.sub_category_description', $flight->sub_category_description);
             $related = $this->flight->all();
             //var_dump($related);
            ?>
           
            <div class="item"> <h4	 class="text-center"> RELATED AIRCRAFT<h5>
              <ul class="clients-list grid-cols-5 hover-7 noborder">
              <?php foreach($related->result() as $_flight){ 
               ?>
                <li><a href="<?php echo base_url('aircraft/details/related/' .$_flight->flight_id); ?>"><?php echo $_flight->make; ?> - <?php echo $_flight->model; ?> <br><img src="<?php echo base_url(); ?>/assets/shared/images/aircraft/exterior/<?php echo $_flight->flight_id; ?>.jpg" alt="" class="img-responsive"> </a></li>
              <?php } ?>
              </ul>
            </div>

                                 ...
                                 <tr>
                                    <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;">
                                                                                          ...
                                                                                          <td width="20%" valign="top" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:30px;" >
                                                                                             ...
                                                                                             <div class="column" style="width:100%;max-width:220px;display:inline-block;vertical-align:top;">
                                                                                                <table class="contents" style="border-spacing:0; width:100%"  >
                                                                                                   <tr>
                                                                                                      <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0px;" align="left"><a href="#" target="_blank"><img src="<?php echo base_url('assets/frontend/aircraft/images/logo/logo.png'); ?>" alt="" width="60" height="60" style="border-width:0; max-width:60px;height:auto; display:block" align="left"/></a></td>
                                                                                                   </tr>
                                                                                                </table>
                                                                                             </div>
                                                                                             <!--[if (gte mso 9)|(IE)]>
                                                                                                      ...
                                                                                                      <td class="inner" style="padding-top:0px;padding-bottom:10px; padding-right:10px;padding-left:10px;">
                                                                                                         <table class="contents" style="border-spacing:0; width:100%" bgcolor="#FFFFFF">
                                                                                                            <tr>
                                                                                                               ...
                                                                                                               <td width="43%" align="left" valign="top"><font style="font-size:11px; text-decoration:none; color:#474b53; font-family: Verdana, Geneva, sans-serif; text-align:left; line-height:16px; padding-bottom:30px"></font></td>
                                                                                                            </tr>
                                                                                                         </table>
                                                                                                      </td>
                                                                                                   </tr>
                                       ...
                                       <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5" bgcolor="#FFFFFF">
                                          <tr>
                                             <td align="left" style="padding:0px 10px 10px 10px">
                                                <?php //conditions ?>
												 <!-- ======= aircraft start ======= --> 
												<table style="width:100% border-spacing:0; border:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5" >
													  <tr>
														<th><h3>Aircraft Wanted<h3></th>
													   
													  </tr>
													  <tr>
														<td style="font: 18px 'Open Sans', sans-serif;font-style: normal; font-weight: normal;font-weight: normal;font-style: normal;line-height: 23px;color: #727272; border:1px solid #e8e7e5; width: 500px;">Name</td>
														<td style="font: 18px 'Open Sans', sans-serif;font-style: normal; font-weight: normal;font-weight: normal;font-style: normal;line-height: 23px;color: #727272; border:1px solid #e8e7e5; width: 500px;">Hugo</td>
													  </tr>
  
												</table>
												<!-- ======= aircraft end ======= --> 
												<!-- ======= message start  ======= --> 
                                                <p style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px "> National Airways Corporation (NAC) is the largest general aviation company in Africa and one of the largest of its kind in the world.
                                                  <?php var_dump($_post);?>
                                                <br />
												<!-- ======= message  end ======= --> 
                                                   <br />
                                                   <br />
                                                   Your best regards, <br />
                                                   NAC Website
                                             </td>
                                          </tr>
                                       </table>
                                                   ...
                                                   <tr>
                                                      <td width="50%" valign="top" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;" >
                                                         ...
                                                         <div class="column" style="width:100%;max-width:399px;display:inline-block;vertical-align:top;">
                                                            <table class="contents" style="border-spacing:0; width:100%">
                                                               <tr>
                                                                  <td width="39%" align="right" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><a href="#" target="_blank"><img src="<?php echo base_url('assets/images/logo_with_name.png'); ?>" alt="" width="59" height="59" style="border-width:0; max-width:59px;height:auto; display:block; padding-right:20px" /></a></td>
                                                                  <td width="61%" align="left" valign="middle" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;">
                                                                     <p style="color:#787777; font-size:13px; text-align:left; font-family: Verdana, Geneva, sans-serif"> &copy; Copyright <?php echo date('Y'); ?> NAC</p>
                                                                  </td>
                                                               </tr>
                                                            </table>
                                                         </div>
                                                                        ...
                                                                        <tr>
                                                                           <td width="32%" align="center" valign="top" style="padding-top:10px">
                                                                              <table width="150" border="0" cellspacing="0" cellpadding="0">
                                                                                 <tr>
                                                                                    <td width="33" align="center"><a href="http://fb.me/ilsspage" target="_blank"><img src="https://gallery.mailchimp.com/fdcaf86ecc5056741eb5cbc18/images/51f10cc9-b6d3-409d-9a64-4080a155b8c7.jpg" alt="facebook" width="36" height="36" border="0" style="border-width:0; max-width:36px;height:auto; display:block; max-height:36px"/></a></td>
